exports.send_otp = async(result) => {
  ...
  exports.forgetPasswordTemplate = async (data) => {
    const template = `
              ...
              <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
               ...
               https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                    <tr>
                                      <td align="center">
                                        <a href="http://localhost:8025/api/v1/user/resetpasswordForm/${data[0].id}"   
...
//   <button><a href="http://localhost:8025/api/v1/user/resetpasswordForm/">Forget Password</a></button>    
  //   ${req[0].id}